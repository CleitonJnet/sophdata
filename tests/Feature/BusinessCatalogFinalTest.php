...
{
    return [
        ['/para-empresas', 'Tecnologia organizada para empresas', 'Solicitar diagnostico empresarial'],
        ['/para-empresas/desenvolvimento-de-software', 'Desenvolvimento de Software', 'Solicitar diagnostico digital'],
        ['/para-empresas/infraestrutura-corporativa-gerenciada', 'Infraestrutura Corporativa Gerenciada', 'Solicitar diagnostico de infraestrutura'],
        ['/para-empresas/servidores-e-ambientes-corporativos', 'Servidores e Ambientes Corporativos', 'Avaliar meu ambiente'],
        ['/para-empresas/planos', 'Planos Empresariais', 'Solicitar diagnostico empresarial'],
        ['/para-empresas/como-trabalhamos', 'Como Trabalhamos', 'Solicitar diagnostico empresarial'],
        ['/para-empresas/contato', 'Contato Empresarial', 'Chamar no WhatsApp'],
        ['/para-empresas/desenvolvimento-de-software/diagnostico-e-discovery', 'Diagnostico e Discovery', 'Solicitar diagnostico digital'],
        ['/para-empresas/desenvolvimento-de-software/sites-e-portais', 'Sites e Portais', 'Planejar meu site'],
        ['/para-empresas/desenvolvimento-de-software/lojas-e-catalogos-digitais', 'Lojas e Catalogos Digitais', 'Planejar meu catalogo'],
        ...
        ['/para-empresas/desenvolvimento-de-software/portais-area-logada-pwa', 'Portais, Area Logada e PWA', 'Planejar meu portal'],
        ['/para-empresas/desenvolvimento-de-software/automacoes-e-integracoes', 'Automacoes e Integracoes', 'Automatizar processos'],
        ['/para-empresas/desenvolvimento-de-software/deploy-hospedagem', 'Deploy e Hospedagem', 'Organizar meu deploy'],
        ['/para-empresas/desenvolvimento-de-software/sustentacao-e-evolucao', 'Sustentacao e Evolucao', 'Evoluir meu sistema'],
        ...
        ['/para-empresas/infraestrutura-corporativa-gerenciada/administracao-mensal', 'Administracao Mensal', 'Contratar administracao mensal'],
        ...
        ['/para-empresas/servidores-e-ambientes-corporativos/active-directory', 'Active Directory', 'Organizar usuarios'],
        ...
        ['/para-empresas/servidores-e-ambientes-corporativos/virtualizacao', 'Virtualizacao', 'Planejar virtualizacao'],
    ];
}
...
test('final business redirects invalid slugs personal regression and sitemap are valid', function () {
    ...
    foreach (businessFinalPages() as [$path]) {
        expect($sitemap)->toContain('https://sophdata.com.br'.$path);
    }
