...
@section('meta_description', 'Soluções de tecnologia para computador lento, Wi-Fi ruim, proteção de contas, arquivos, estudos, IA e montagem de PCs.')
...
@section('content')
    ...
    <x-site.hero-banner
        ...
        :image="$portal['image']"
        image-alt="Soluções de tecnologia para o dia a dia"
        variant="light"
    />
    ...
    <section id="solutions" class="scroll-mt-48 bg-white py-16 sm:py-20 lg:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <x-site.section-heading
                ...
                description="Escolha o problema mais próximo da sua necessidade e encontre a solução adequada."
                centered
            />
            <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                @foreach ($featuredProblems as $card)
                    <x-site.category-card
                        ...
                        :image="$card['image']"
                        :url="route('portal.personal.category', $card['target_category_slug'])"
    ...
    <section class="bg-brand-50 py-16 sm:py-20 lg:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <x-site.section-heading
                eyebrow="Categorias pessoais"
                title="Soluções organizadas por área"
                description="Escolha a solução mais próxima do seu problema e veja os pacotes."
                centered
            />
            <div class="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                @foreach ($categories as $category)
                    <x-site.category-card
                        ...
                        :url="route('portal.personal.category', $category['slug'])"
    ...
    <section class="bg-brand-50 py-16 sm:py-20 lg:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <x-site.section-heading
                ...
                description="Computador, Wi-Fi, backup, segurança, estudos, carreira, IA e montagem de PC."
                centered
            />
    ...
    <x-site.cta-section
        ...
        button-text="Quero atendimento"
        :button-url="$whatsappUrl"
        :image="config('sophdata.images.banner')"
        image-alt="Atendimento pessoal SophData"
    />
@endsection
