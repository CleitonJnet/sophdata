...
@section('content')
    @php
        $whatsappMessage = 'Olá! Quero iniciar atendimento com a SophData. Meu atendimento é para: [pessoa física/empresa]. Preciso resolver: [descreva]. Urgência: [sim/não]. Pode ser remoto: [sim/não]. Pacote de interesse: [se houver].';
    ...
    <x-site.hero-banner
        ...
        primary-button-text="Iniciar atendimento"
        :primary-button-url="$whatsappUrl"
        secondary-button-text="Solicitar atendimento empresarial"
        :secondary-button-url="$businessWhatsappUrl"
        tertiary-button-text="Quero atendimento"
        :tertiary-button-url="$personalWhatsappUrl"
    ...
    <section class="bg-slate-50 py-16 sm:py-20 lg:py-24">
        <div class="mx-auto grid max-w-7xl gap-6 px-4 sm:px-6 lg:grid-cols-4 lg:px-8">
            ...
            <article class="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
                ...
                <p class="mt-3 leading-7 text-slate-600">Atendimento remoto para muitas demandas e presencial quando combinado.</p>
        ...
        <div class="mx-auto grid max-w-7xl items-start gap-12 px-4 sm:px-6 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
            <div>
                <x-site.section-heading
                    ...
                    title="Perguntas para orientar o atendimento"
                ...
                <div class="mt-8 rounded-3xl bg-brand-50 p-6 ring-1 ring-brand-100">
                    ...
                    <p class="mt-2 leading-7 text-slate-600">O link abre um canal externo de contato com uma mensagem-base. Complete apenas o que fizer sentido para sua solicitação.</p>
                </div>
            </div>
