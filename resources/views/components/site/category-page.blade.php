...
@php
    ...
    $steps = [
        ['title' => 'Primeiro contato', 'description' => 'Você explica o problema, o contexto e o resultado que espera.'],
        ['title' => 'Diagnóstico', 'description' => 'A necessidade é analisada para definir prioridades e o nível de atendimento.'],
        ...
        ['title' => 'Orientação final', 'description' => 'Você entende o que foi feito e recebe orientações para usar ou manter a solução.'],
    ];
    $choices = [
        [
        ...
        [
            ...
            'description' => 'Se você quer resolver a necessidade e organizar melhor o ambiente, com melhorias e acompanhamento.',
        ],
        [
...
<nav aria-label="Breadcrumb" class="border-b border-slate-200 bg-white">
    <ol class="mx-auto flex min-h-12 max-w-7xl items-center gap-2 px-4 py-3 text-sm sm:px-6 lg:px-8">
        <li>
...
<section class="bg-white py-16 sm:py-20 lg:py-24">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <x-site.section-heading
            ...
            title="O que essa solução resolve?"
            description="Situações reais que podem ser organizadas com orientação e um escopo adequado."
            centered
        />
...
<section id="packages" class="scroll-mt-48 bg-slate-50 py-16 sm:py-20 lg:py-24">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <x-site.section-heading
            eyebrow="Pacotes de atendimento"
            title="Escolha o pacote ideal"
            description="Comece pelo essencial, avance para o recomendado ou escolha a solução completa."
            centered
        />
...
<section class="bg-brand-50 py-16 sm:py-20 lg:py-24">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <x-site.section-heading
            eyebrow="Decisão simples"
            title="Como escolher?"
            description="Use o resultado que você espera como ponto de partida."
            centered
        />
...
<section class="bg-white py-16 sm:py-20 lg:py-24">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <x-site.section-heading
            ...
            description="Um processo claro para entender, propor, executar e orientar."
            centered
        />
...
<section class="bg-slate-50 py-16 sm:py-20 lg:py-24">
    <div class="mx-auto max-w-4xl px-4 sm:px-6">
        <x-site.section-heading
            ...
            title="Perguntas sobre esta solução"
            description="Respostas para ajudar você a avançar com mais segurança."
            centered
        />
...
<x-site.cta-section
    :title="$isBusiness ? 'Pronto para organizar esta área da sua empresa?' : 'Quer resolver isso com orientação clara?'"
    :description="$isBusiness
        ? 'Inicie o atendimento e receba orientação para escolher o melhor pacote.'
        : 'Inicie o atendimento e receba ajuda para escolher o pacote mais adequado.'"
    :button-text="$primaryCta"
